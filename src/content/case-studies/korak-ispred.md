...
duration: "75 days"
services: ["CRO Audit", "UX Research", "A/B Testing", "Landing Page CRO"]
results:
  - metric: "Conversion Rate"
    before: "4.6%"
    after: "10.9%"
    change: "+137%"
  - metric: "Course Page to Enrol Rate"
    before: "11%"
    after: "26%"
    change: "+136%"
  - metric: "Checkout Abandonment"
    ...
    change: "-40%"
testimonial:
  quote: "We had good traffic and good courses, but conversions were frustrating. The audit showed us exactly why people were leaving without enrolling. The changes Mario made have been transformative — we more than doubled our conversion rate."
  author: "Korak Ispred Team"
  role: "Korakispred.io"
featured: true
