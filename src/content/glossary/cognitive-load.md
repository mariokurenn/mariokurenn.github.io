...
faqs:
  - question: "What is cognitive load in UX and CRO?"
    answer: "Cognitive load is the total mental effort required to process, understand, and act on information. In UX and CRO, high cognitive load occurs when a page presents too much information simultaneously, uses unclear language, has inconsistent visual hierarchy, or requires visitors to figure out what to do next. When cognitive load exceeds a visitor's threshold, they abandon — not because they're uninterested, but because the effort required to continue exceeds the perceived value of doing so."
  - question: "How does cognitive load affect conversion rate?"
...
| Type | Cause | CRO Impact |
|------|-------|-----------|
| **Intrinsic** | Complexity of the subject matter | Usually unavoidable — simplify where possible |
| **Extraneous** | Poor design, unclear layout, cluttered UI | Entirely avoidable — this is what CRO targets |
| **Germane** | Learning and understanding | Useful — good onboarding and explanations |
...
Reducing cognitive load is often the fastest path to conversion improvement. Unlike adding new content or features, removing friction costs nothing and delivers results immediately. It's a core focus of every [CRO audit](/services/cro-audit/).
