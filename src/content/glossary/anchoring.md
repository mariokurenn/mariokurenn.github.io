...
relatedTerms: ["decoy-effect", "framing-effect", "value-proposition", "loss-aversion"]
publishDate: "2026-03-24"
faqs:
  - question: "What is anchoring in marketing?"
    answer: "Anchoring is a cognitive bias where people rely heavily on the first piece of information they encounter (the 'anchor') when making decisions. In marketing, this means the first price, number, or claim a visitor sees becomes the reference point against which all subsequent information is judged. A €999 product shown next to a crossed-out €1,499 price is perceived as a bargain — even if €999 was always the intended price."
...
Each of these is a single-variable test with measurable revenue impact. For methodology, see [A/B Testing Best Practices](/blog/ab-testing-best-practices/).
