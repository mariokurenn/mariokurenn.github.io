...
imageAlt: "Bar chart comparing conversion rate benchmarks across ecommerce, SaaS, B2B, and landing page industries for 2025 and 2026"
draft: false
---
...
<div style="display:grid;grid-template-columns:repeat(2,1fr);gap:1rem;margin:1.5rem 0;">
  <div style="background:var(--color-surface);border:1px solid var(--color-border);border-radius:var(--radius-md);padding:1.25rem;">
    <div style="font-size:1.6rem;font-weight:800;color:var(--color-accent);line-height:1;">2.5–3%</div>
    <div style="font-size:0.8rem;font-weight:700;text-transform:uppercase;letter-spacing:0.06em;color:var(--color-text-muted);margin-top:0.35rem;">Ecommerce websites</div>
    <div style="font-size:0.8rem;color:var(--color-text-muted);margin-top:0.2rem;">Average; above 3.5% is strong</div>
  </div>
  <div style="background:var(--color-surface);border:1px solid var(--color-border);border-radius:var(--radius-md);padding:1.25rem;">
    <div style="font-size:1.6rem;font-weight:800;color:var(--color-accent);line-height:1;">2–5%</div>
    <div style="font-size:0.8rem;font-weight:700;text-transform:uppercase;letter-spacing:0.06em;color:var(--color-text-muted);margin-top:0.35rem;">B2B lead generation</div>
    <div style="font-size:0.8rem;color:var(--color-text-muted);margin-top:0.2rem;">Broad range; depends heavily on offer type</div>
  </div>
  <div style="background:var(--color-surface);border:1px solid var(--color-border);border-radius:var(--radius-md);padding:1.25rem;">
    <div style="font-size:1.6rem;font-weight:800;color:var(--color-accent);line-height:1;">6.6%</div>
    <div style="font-size:0.8rem;font-weight:700;text-transform:uppercase;letter-spacing:0.06em;color:var(--color-text-muted);margin-top:0.35rem;">Landing pages (median)</div>
    <div style="font-size:0.8rem;color:var(--color-text-muted);margin-top:0.2rem;">Per Unbounce; top performers exceed 11%</div>
  </div>
  <div style="background:var(--color-surface);border:1px solid var(--color-border);border-radius:var(--radius-md);padding:1.25rem;">
    <div style="font-size:1.6rem;font-weight:800;color:var(--color-accent);line-height:1;">19.3%</div>
    <div style="font-size:0.8rem;font-weight:700;text-transform:uppercase;letter-spacing:0.06em;color:var(--color-text-muted);margin-top:0.35rem;">Email-driven traffic</div>
    <div style="font-size:0.8rem;color:var(--color-text-muted);margin-top:0.2rem;">Highest-converting channel by a wide margin</div>
  </div>
</div>
...
To [calculate your conversion rate](/blog/how-to-calculate-conversion-rate/), divide conversions by total sessions (or visitors), multiply by 100. Simple in theory, surprisingly contested in practice once you factor in multi-device journeys and attribution windows.

---

## E-Commerce Conversion Rate Benchmarks

The global ecommerce average sits somewhere between 1.64% and 2.76% depending on which study you use — [IRP Commerce](https://www.irpcommerce.com/ecommercemarketdata.aspx) tends to land lower, [Dynamic Yield](https://marketing.dynamicyield.com/benchmarks/conversion-rate/) higher. I'd put the working average at 2–2.5% for most online retailers.
...
<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1rem;margin:1.5rem 0;">
  <div style="background:var(--color-surface);border:2px solid var(--color-accent);border-radius:var(--radius-md);padding:1.25rem;text-align:center;">
    <div style="font-size:1.75rem;font-weight:800;color:var(--color-accent);line-height:1;">~3.9%</div>
    <div style="font-size:0.8rem;font-weight:700;color:var(--color-heading);margin-top:0.5rem;">Desktop</div>
  </div>
  <div style="background:var(--color-surface);border:1px solid var(--color-border);border-radius:var(--radius-md);padding:1.25rem;text-align:center;">
    <div style="font-size:1.75rem;font-weight:800;color:var(--color-accent);line-height:1;">~3.1%</div>
    <div style="font-size:0.8rem;font-weight:700;color:var(--color-heading);margin-top:0.5rem;">Tablet</div>
  </div>
  <div style="background:var(--color-surface);border:1px solid var(--color-border);border-radius:var(--radius-md);padding:1.25rem;text-align:center;">
    <div style="font-size:1.75rem;font-weight:800;color:var(--color-accent);line-height:1;">~2.77%</div>
    <div style="font-size:0.8rem;font-weight:700;color:var(--color-heading);margin-top:0.5rem;">Mobile</div>
  </div>
</div>

*Source: [Contentsquare Digital Experience Benchmark](https://contentsquare.com/digital-experience-benchmark/)*

The mobile gap is real, persistent, and mostly fixable. People browse on mobile, buy on desktop — but only when the mobile experience is bad enough to make them switch. Close that gap and you're not competing for more traffic, you're monetising the traffic you already have. For a full breakdown of where mobile funnels usually break, see [mobile conversion rate optimization](/blog/mobile-conversion-rate-optimization/).
...
The average B2B website conversion rate sits between 2–5% ([Ruler Analytics](https://www.ruleranalytics.com/blog/insight/conversion-rate-by-industry/)). Legal services can hit 7%+; complex B2B SaaS averages around 1.1%. The gap between sectors is wider than in ecommerce.
...
For SaaS specifically, the trial model shapes everything. The numbers look dramatically different depending on how the trial is structured ([First Page Sage](https://firstpagesage.com/seo-blog/saas-free-trial-conversion-rate-benchmarks/)):

<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1rem;margin:1.5rem 0;">
  <div style="background:var(--color-surface);border:2px solid var(--color-accent);border-radius:var(--radius-md);padding:1.25rem;text-align:center;">
    <div style="font-size:1.75rem;font-weight:800;color:var(--color-accent);line-height:1;">48.8%</div>
    <div style="font-size:0.8rem;font-weight:700;color:var(--color-heading);margin-top:0.5rem;">Opt-out trial</div>
    <div style="font-size:0.75rem;color:var(--color-text-muted);margin-top:0.25rem;">Credit card required — highest CVR, lower volume</div>
  </div>
  <div style="background:var(--color-surface);border:1px solid var(--color-border);border-radius:var(--radius-md);padding:1.25rem;text-align:center;">
    <div style="font-size:1.75rem;font-weight:800;color:var(--color-accent);line-height:1;">18.2%</div>
    <div style="font-size:0.8rem;font-weight:700;color:var(--color-heading);margin-top:0.5rem;">Opt-in trial</div>
    <div style="font-size:0.75rem;color:var(--color-text-muted);margin-top:0.25rem;">No card required — balanced approach</div>
  </div>
  <div style="background:var(--color-surface);border:1px solid var(--color-border);border-radius:var(--radius-md);padding:1.25rem;text-align:center;">
    <div style="font-size:1.75rem;font-weight:800;color:var(--color-accent);line-height:1;">2.6%</div>
    <div style="font-size:0.8rem;font-weight:700;color:var(--color-heading);margin-top:0.5rem;">Freemium</div>
    <div style="font-size:0.75rem;color:var(--color-text-muted);margin-top:0.25rem;">Lowest CVR, widest top-of-funnel</div>
  </div>
</div>
...
Paid search sits at 7.52% on average ([WordStream 2025](https://www.wordstream.com/blog/2025-google-ads-benchmarks)), but the industry spread is dramatic:
...
The headline figure is the [Unbounce](https://unbounce.com/conversion-benchmark-report/) median landing page CVR of **6.6%** across all industries. Top performers sit above 11%. Generic website pages — not dedicated landing pages — average closer to 1.7% for form submissions.

Some other micro-conversion benchmarks worth knowing:

- **Add-to-cart rate:** 8–10% average
- **Checkout completion rate:** 40–50%; top performers above 73% on desktop ([Bold Commerce](https://boldcommerce.com/reports/the-checkout-benchmark))
- **Form completion rate (once started):** ~66% ([Zuko](https://www.zuko.io/benchmarking/industry-benchmarking))
...
Use these numbers to understand where you stand, then use the revenue math to decide what to do about it. [Calculating your conversion rate](/blog/how-to-calculate-conversion-rate/) and running it through a [CRO ROI calculator](/tools/cro-roi-calculator/) gives you the actual business case.

These benchmarks are baselines. The top performers in every category — the ones at 4–5% ecommerce CVR, the SaaS businesses at 25%+ free trial conversion — didn't get there by optimizing toward the average. They got there by running structured tests, fixing specific problems, and compounding small improvements over time. That's [what CRO work actually looks like](/blog/what-is-conversion-rate-optimization/) in practice.

---

**Related reading:**
- [CRO Audit Checklist: 37 Questions to Find Every Conversion Leak](/blog/cro-audit-checklist/)
- [A/B Testing Best Practices](/blog/ab-testing-best-practices/)
- [Mobile Conversion Rate Optimization](/blog/mobile-conversion-rate-optimization/)
- [B2B Conversion Rate Optimization: The Complete Guide](/blog/b2b-conversion-rate-optimization/)
- [How to Reduce Cart Abandonment Rate](/blog/how-to-reduce-cart-abandonment-rate/)

---

Want to know how your site compares in your specific category? [Get a free CRO audit →](/contact/) — I'll benchmark your funnel against your actual sector and show you where the biggest opportunity is.
